...
public class VariableRateBillCalculatorTest {
    ...
    private BillCalculator billCalulator = new VariableRateBillCalculator(new DaytimePeakPeriod());
    ...
    @Test
    public void testCallMadeAtStartOfOffPeakPeriod() {
        DateTime startTime = formatter.parseDateTime("2011-11-11 19:00");
        DateTime endTime = formatter.parseDateTime("2011-11-11 20:00");
    ...
    @Test
    public void testCallMadeAtStartOfPeakPeriod() {
        DateTime startTime = formatter.parseDateTime("2011-11-11 07:00");
    ...
    public void testCallsWithMixedDaytimePeriod() {
        ...
        BigDecimal callCost = billCalulator.getCallCost(call, tariff);
        BigDecimal expectedCallCost = new BigDecimal(2520);
